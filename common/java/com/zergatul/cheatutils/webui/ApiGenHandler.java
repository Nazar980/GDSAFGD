...
public class ApiGenHandler implements HttpHandler {
    ...
    private List<String> generateLines() {
        ...
        lines.add(String.format("// Minecraft Version: %s (%s)", SharedConstants.getCurrentVersion().name(), ModEnvironment.getModLoader()));
        lines.add(String.format("// CheatUtils Version: %s", ModEnvironment.getModVersion()));
